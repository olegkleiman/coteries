...
class SendSMS extends React.Component {
  ...
  constructor(props) {
    ...
    _handleSendSMS = this._handleSendSMS.bind(this);
  }
  ...
  _handleSendSMS= () => {
    ...
    fetch(url)
      .then( (response) => {
        ...
        self.props.navigation.navigate('GetToken');
  ...
  render() {
    ...
    return (<Container>
              <View style={styles.appBar}>
                ...
                <Text style={styles.navigationTitle}>Login. Step 1 of 2</Text>
...
export default connect()(SendSMS);
